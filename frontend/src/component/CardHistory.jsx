    ...
    return (
        <div className="grid md:grid-cols-2 gap-10 lg:grid-cols-4 gap-10 place-items-center py-10">
            {histories.map((history) =>(
                ...
                <a href="#">
                    <h5 className="mb-2 text-lg font-bold tracking-tight text-left text-gray-900 dark:text-white">{history.dateTimeCompleted.slice(0,10)}</h5>
                ...
                <ul className ="list-disc space-x-2 grid grid-cols-1">
                    {history.completedExercises.map((exercise) => (
                ...
                <p className="mb-3 font-normal text-start text-gray-700 dark:text-gray-400">Duration: {history.routineDuration}</p>
                <p className="mb-3 font-normal text-start text-gray-700 dark:text-gray-400">Calories Burnt: {history.caloriesBurned}</p>
