...
function Navbar() {
    ...
    const [navbar, setNavbar] = useState(['Planner', 'Gyms', 'Profile'])
            ...
            <div className="bg-yellow-300 flex justify-between items-center w-full h-20 px-2  2xl:px-16">
                ...
                <div className='hidden sm:block'>
                    <ul>
                        {/* Links */}
                        {navbar.map((item) => (
                            <li className="font-bold cursor-pointer inline-block px-6 py-2 mx-2 rounded-md hover:bg-green-300">{item}</li>
                        ))}
